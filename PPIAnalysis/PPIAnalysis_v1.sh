#!/bin/bash
#set -x
maindir="/ifs/faculty/narr/schizo/CONNECTOME/HCP_OUTPUT/Analysis_JL"
masksdir="${maindir}/Masks/PPI"
#PPI Analysis
...
happy="cond001.txt"
objects="cond004.txt"
Subjects=$(cat ${maindir}/logstxt/PPIlist.txt)
DirectionList=""
...
do
evsdir="${maindir}/DATA/${sub}/${sub}_output/sub-${sub}/MNINonLinear/Results/task-facematching_acq-${dir}_run-01/EVs"
...
for dir in ${DirectionList}
do
datadir="${maindir}/DATA/${sub}/${sub}_output/sub-${sub}/MNINonLinear/Results/task-facematching_acq-${dir}_run-01/task-facematching_acq-${dir}_run-01_JL_hp200_s5_level1.feat"
ppidir="${maindir}/DATA/${sub}/${sub}_output/sub-${sub}/MNINonLinear/Results/task-facematching_acq-${dir}_run-01/PPItest"
mkdir ${ppidir}
