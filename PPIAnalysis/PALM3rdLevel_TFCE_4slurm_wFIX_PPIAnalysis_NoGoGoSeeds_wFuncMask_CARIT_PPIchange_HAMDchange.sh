...
do
	args="${args} -cifti ${mainoutputdir}/../TP1-TP3_Imgs/${subj}/${PPIroi}/${COPE}_TP1-TP3.dtseries.nii -column 1"
done
...
echo "test"
palm -i Y.${extension} -transposedata -d ../design.mat -t ../design.con -o results_cifti -n ${niter} -m ${FuncMaskdir}/${FuncMaskname}.dscalar.nii -corrcon -logp -accel tail -zstat -fdr 
echo "test1"	
...
palm -i Y_subcortical.nii -d ../design.mat -t ../design.con -o results_dense_subcortical -m ${FuncMaskname}_subcortical.nii -n ${niter} -corrcon -C ${cluster_thr} -Cstat "extent" -logp -accel tail -T -zstat -fdr
#3- Run PALM with TFCE for cortical surfaces:#################
palm  -i Y_left.func.gii -i Y_right.func.gii -m ${FuncMaskname}_left.func.gii -m ${FuncMaskname}_right.func.gii -d ../design.mat -t ../design.con -o results_dense_cortical -n ${niter} -corrcon -corrmod -C ${cluster_thr} -Cstat "extent" -logp -accel tail -T -tfce2D -s L_midthickness.surf.gii -s R_midthickness.surf.gii -zstat -fdr
