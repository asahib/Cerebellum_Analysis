...
grouplist="KetTP1 KetTP2 KetTP3 KetTP4 HC MDDTP1 MDDTP3 ECTTP1 ECTTP2"
...
Subjlist=$(</nafs/narr/jloureiro/CEREBELLUM/txtfiles/${group}.txt)
		...
		wb_command -cifti-average ${mainconndir}/GroupAnalysis/${group}_MEAN/MEANdenseConnectome_${group}.dconn.nii ${args} 
