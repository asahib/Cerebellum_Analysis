...
Subjlist=$(</nafs/narr/jloureiro/CEREBELLUM/txtfiles/ALLSUBS.txt) #Space delimited list of subject IDs
...
--output=/nafs/narr/jloureiro/projects/DenseConnectome/${line}_SeedBased.log --export BATCH_SUB=${line} /nafs/narr/jloureiro/scripts/fMRI/CEREBELLUM/DenseConnectome_SeedBased.sh
