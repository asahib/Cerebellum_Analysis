...
do
	...
	wb_command -cifti-stats ${betaimgsdir}/${sub}_task-facematching_JL_20cons_clean_level2_percChange_${cope}_hp200_s5.dscalar.nii -reduce MEAN -roi ${CombinedMasksdir}/MERGEDROIs_cerebellum_KTP1KTP3cope2c1.dscalar.nii >> ${logdir}/MERGEDROIs_${cope}_${FuncMaskname}_test.txt
