...
#suitmasks="Right_V Left_V Right_VI Left_VI Vermis_V Right_CrusI Left_CrusI Vermis_CrusI Right_CrusII Left_CrusII Vermis_CrusII Right_VIIb Left_VIIb Vermis_VIIb Right_VIIIa Left_VIIIa Left_VIIIb Left_IX"
...
then
	...
	wb_command -volume-math 'x > 1.3' ${funcmasksdir}/Mask_KTP1_KTP3_cope2_c1_p005.nii -var 'x' ${funcmapsdir}/cope2/results_dense_subcortical_tfce_ztstat_fwep_c1.nii 
...
then
	...
	for roi in ${suitmasks}
	do
		wb_command -volume-math 'x * y' ${combinedmasksdir}/${roi}_KTP1KTP3cope2c1.nii -var 'x' ${funcmasksdir}/Mask_KTP1_KTP3_cope2_c1_p005.nii -var 'y' ${suitmasksdir}/${roi}_downsampled.nii
		...
		args="${args} -cifti ${combinedmasksdir}/${roi}_KTP1KTP3cope2c1.dscalar.nii "

	done

	
	wb_command -cifti-merge ${combinedmasksdir}/MERGEDROIs_cerebellum_KTP1KTP3cope2c1.dscalar.nii ${args} 
